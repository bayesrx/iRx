...
% Gibbs sampler for Cell line-patient sub-model of iRx model    
% using MGPS prior (due to BHATTACHARYA AND DUNSON(2011))on factor loadings
addpath './Scripts';
...
[etacout,etapout,Lambdaout,Lambda_MCMC, nof1out,nofout_MCMC,Omegapureout,Omegapout,Omegacout,StdTrain, StdTest, VY]= ...
    iRx_spfact(C,P,nrun,burn,thin,seed); 
